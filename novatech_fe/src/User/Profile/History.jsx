...
const History = () => {
  ...
  return (
    <div>
      ...
      <Grid container>
        <Grid item xs={12} container sx={{ bgcolor: "#FFF2D7", height:"100px" }} mx={5}>
          <Grid item xs={6}>
            <div className="m-5 border-r-2 border-r-[#333] text-center">
        ...
        <Grid item xs={12} spacing={3} container justifyContent={"center"}>
          <Grid item xs={12} container justifyContent={"center"} mt={5}>
            <img src="https://cellphones.com.vn/smember/_nuxt/img/empty.db6deab.svg"></img>
          </Grid>
          <Grid item xs={12}>
