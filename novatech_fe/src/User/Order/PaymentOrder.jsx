          ...
          <div className="">
            ...
            <div className="relative">
              <input
                ...
                id="card-holder"
                name="card-holder"
                className="w-full rounded-md bg-white border border-gray-200 px-4 py-3 pl-11 text-sm uppercase shadow-sm outline-none focus:z-10 focus:border-blue-500 focus:ring-blue-500"
            ...
            <div className="flex">
              <div className="relative w-7/12 flex-shrink-0">
                <input
                  ...
                  id="card-no"
                  name="card-no"
                  className="w-full rounded-md bg-white border border-gray-200 px-2 py-3 pl-11 text-sm shadow-sm outline-none focus:z-10 focus:border-blue-500 focus:ring-blue-500"
              ...
              <input
                type="text"
                name="credit-expiry"
                className="w-full rounded-md bg-white border border-gray-200 px-2 py-3 text-sm shadow-sm outline-none focus:z-10 focus:border-blue-500 focus:ring-blue-500"
                placeholder="MM/YY"
              />
              <input
                type="text"
                name="credit-cvc"
                className="w-1/6 flex-shrink-0 bg-white rounded-md border border-gray-200 px-2 py-3 text-sm shadow-sm outline-none focus:z-10 focus:border-blue-500 focus:ring-blue-500"
                placeholder="CVC"
              />
            </div>
            <div className="my-6 border-t border-b py-5">
              <div className="flex items-center justify-between">
                ...
                <p className="font-semibold text-[#DD5746]">28.990.000đ</p>
              </div>
              <div className="flex items-center justify-between">
                <p className="text-sm font-medium text-gray-900">Phí vận chuyển</p>
                <p className="font-semibold text-gray-900">-15000đ</p>
              </div>
            </div>
            <div className="my-6 flex items-center justify-between">
              <p className="text-lg text-gray-900">Tổng trả</p>
              <p className="text-2xl font-semibold text-gray-900">28.975.000đ</p>
            </div>
          </div>
